...
*   `Abstraction`是使用来自`Implementer`的`methodA`的接口或类。见图 [10-1](#Fig1) 。
    ...
    ![A435115_1_En_10_Fig1_HTML.jpg](A435115_1_En_10_Fig1_HTML.jpg)
...
![A435115_1_En_10_Fig2_HTML.jpg](A435115_1_En_10_Fig2_HTML.jpg)
...
您使用桥接模式将模式构建器与底层数据库分离。作为一个简单的例子，您还使用了桥模式来构建消息传递应用程序的主干。
