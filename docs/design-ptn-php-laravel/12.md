...
主持人利用 PHP 中的[魔法方法](http://php.net/manual/en/language.oop5.magic.php) [<sup>4</sup>](#Fn4) ，比如 __call() [<sup>5</sup>](#Fn5) 和 __get() [<sup>6</sup>](#Fn6) ，来绕过你在修改后的怪物装饰器中发现的消失责任问题。那么你什么时候使用演示者呢？如果满足以下任一条件，请使用它们:
