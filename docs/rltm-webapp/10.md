...
![9781430246206_Fig10-01.jpg](images/9781430246206_Fig10-01.jpg)

[图 10-1。](#_Fig1)在 Pusher 中创建新应用程序

点击“创建应用程序”，然后在下一个屏幕上点击“API 访问”，调出您的 API 凭证(见[图 10-2](#Fig2) )。

![9781430246206_Fig10-02.jpg](images/9781430246206_Fig10-02.jpg)
...
![image](images/sq.jpg) **注意**该应用中的代码只经过了 jQuery 1 . 8 . 2 版本的测试。较新的版本可能会带来一些问题，只有经过全面测试后才能使用。
...
![image](images/sq.jpg) **提示**用闭包[脚注]包装你的应用程序脚本可以防止与其他使用美元符号(`$`)快捷方式的库发生冲突，比如 Prototype 和 MooTools。
...
![image](images/sq.jpg) **注意**`Pusher`对象初始化和通道订阅被直接放在页脚中，以利用 PHP 支持的模板。
...
![image](images/sq.jpg) **注意**这些方法现在还不做任何事情；您将在下一节中添加该功能。
...
![image](images/sq.jpg) **注意**为了保持 JavaScript 简洁，我们在这个脚本中对所有三个变量只使用了一次`var`声明。这主要是一种风格上的选择，但是也有一些观点认为使用这种方法可以获得微小的性能提升。
...
![9781430246206_Fig10-08.jpg](images/9781430246206_Fig10-08.jpg)
...
![9781430246206_Fig10-09.jpg](images/9781430246206_Fig10-09.jpg)
