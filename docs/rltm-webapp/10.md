...
要获取它们，请在`http://pusher.com`登录您的帐户，并从您的仪表板左上角选择“添加新应用”。将你的新应用命名为“实时网络应用”，不要勾选下面的两个框(见[图 10-1](#Fig1) )。

![9781430246206_Fig10-01.jpg](img/9781430246206_Fig10-01.jpg)

[图 10-1。](#_Fig1)在 Pusher 中创建新应用

点击“创建应用”，然后在下一个屏幕上点击“API 访问”，调出您的 API 凭证(见[图 10-2](#Fig2) )。
...
[图 10-4。](#_Fig4)Pusher 控制台显示关闭和重新打开房间的事件
