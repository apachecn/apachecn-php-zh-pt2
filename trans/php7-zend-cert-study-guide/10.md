...
![A456636_1_En_10_Fig1_HTML.jpg](../Images/A456636_1_En_10_Fig1_HTML.jpg)
...
![A456636_1_En_10_Fig2_HTML.jpg](../Images/A456636_1_En_10_Fig2_HTML.jpg)
...
数据库连接会在运行脚本结束时自动关闭，除非您将它们持久化。持久数据库连接不会被关闭，而是被缓存以供脚本的另一个实例使用。这减少了每次 web 应用程序运行时需要连接到数据库的开销。
